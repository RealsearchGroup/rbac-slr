...
\begin{itemize}
	\item Addition: The extension model incorporates additional elements with regards to context/constraints and their relations with existing elements of the RBAC standard. Models in this category do not change the RBAC$_{m}$. We found 23 papers in this category.
