...
%The concept of authorization and access control
...
%there would be a reasonable assurance being based off a well thought out model.  
As extensions to the RBAC Reference Mode
come along, thought and time should be given to how features and nuances of their models may impact implementation
to achieve the same goals as the original standard.  The primary sources showed a lack of implementation
...
%\greybox{Research on RBAC extension models shows a lack of application and testing in the real world scenarios that the models are ultimately designed for.}
