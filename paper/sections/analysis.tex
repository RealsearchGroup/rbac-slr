...
The predominant domain for which extension models have been generated for is that of the medical domain with 9 of 29 mentioning scenarios or requirements of that industry.
