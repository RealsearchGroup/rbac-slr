...
The RBAC standard model provides an abstraction of authorization based on user role assignment (UA) and role
...
evaluation types and which primary sources provided which type.  In some cases a single primary source provided mutliple evaluation
types.
...
extenion models are lacking. 

The primary source of validation a developer or practioner may encounter is a qualitative discussion of real-world
...
of how an extension model handles a real-world scenario provides developers and practioners ancedotal evidence at best
