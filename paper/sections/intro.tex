...
Since the introduction of the RBAC standard, researchers and practitioners have proposed domain-targeted extensions that add one or more features on top of components in the RBAC Reference Model \cite{kuhn2010adding}.
...
\item RQ3: How are RBAC extension models implemented by their authors?
\item RQ4: How are RBAC extension models evaluated by their authors?
\item RQ5: What domains have been targeted by RBAC extension models?
\item RQ6: What commonalities exist across RBAC extension models?
\end{itemize}
