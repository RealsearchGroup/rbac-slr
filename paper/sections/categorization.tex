...
Based on data extracted from the primary sources and the English definitions for each noun-phrase we provide a definition for each observed model category. 
